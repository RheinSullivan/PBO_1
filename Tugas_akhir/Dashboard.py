...
class Dashboard:
    def __init__(self):
        ...
        self.file_menu.add_command(label='Login', command=lambda: self.new_window("Login Account", FormLogin))
        self.file_menu.add_command(label='Exit', command=self.root.destroy)

        # add menu items to menu Admin
        self.admin_menu.add_command(label='Form Anggota', command=lambda: self.new_window("Form anggota", FormAnggota))
        ...
        self.mahasiswa_menu.add_command(label='Anggota UKM', command=lambda: self.new_window("Anggota UKM", FrmAnggotaView))
